...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
            ...
            if __name__ == "__main__":
                ...
                if result_final > 20:
                    ...
                    self.label10 = tk.Label(self,
                                            ...
                                            fg="red", bg="silver", font="none 22")
                    self.label10.place(x=610, y=250)

                    self.label11 = tk.Label(self, text=final_name, bg="silver", fg="black", font="none 22")
                    self.label11.place(x=610, y=280, height=80)

                    self.label12 = tk.Label(self, text="%s Kg\n" % ext_weight, bg="silver", fg="black",
                                            font="none 22")
                    self.label12.place(x=810, y=297, height=80)

                    self.label13 = tk.Label(self, text="Rs.%s" % price, bg="silver", fg="black", font="none 22")
                    self.label13.place(x=990, y=280, height=80)

                    self.label17 = tk.Label(self, text="cost of %s : Rs %s \n" % (final_name, price), bg="silver",
                                            fg="black", font="none 22")
                    ...
                    def thanks():
                        self.label15 = tk.Label(self, text="Thank you for shopping with us :)", bg="silver", fg="blue",
                                            font="Times 30 italic ")
                        self.label15.place(x=610, y=500)

                    button5 = tk.Button(self, text="Print", bg="white", fg="black", activebackground="green",
                                        activeforeground="Yellow", bd="10",
                                        font="none 20", height=0, width=5, padx="0", pady="0", wraplength=0,command = thanks)
                    button5.place(x=830, y=600)
        ...
        button2 = tk.Button(self, text="Click to begin", bg="white", fg="black", activebackground="green",
                            activeforeground="Yellow", bd="10",
                            font="none 20 bold", height=0, width=20, padx="0", pady="0", wraplength=0,
                            command=mainprogram)
        ...
        button4 = tk.Button(self, text="Reset", bg="white", fg="black", activebackground="green",
                            activeforeground="Yellow", bd="10",
                            font="none 16 bold", height=0, width=5, padx="0", pady="0", wraplength=0,
                            command=spec)
